#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Feed finder. MIT licensed. Forked into this project so that I can port to py3
and not get warnings from BeautifulSoup.

Based on https://github.com/dfm/feedfinder2/blob/master/feedfinder2.py"""
...
def find_feeds(url, check_all=False, user_agent=None):
    ...
    tree = BeautifulSoup(text, _BEAUTIFUL_PARSER)
    links = []
